 ...
 * @FilePath: \Demo0\SRC\jointDataProcess.cpp
 * @Description:
 *
...
float R_reductor[9]={284.9231,213.7,171.0*5/3,181.22,144.9*5/3,33.0*5/3,0.5,12,0.5};
int pulse_offset[9]={-513848,-331982,11630709,-382944720,-506320482,42662099,126836473,49936221,-239976};
